    ...
    {#if showSettings}
      <div class="settings-panel">
        ...
        <div class="settings-grid">
          ...
          <label>Routing<select bind:value={settings.region}><option value="europe">Europe</option><option value="americas">Americas</option><option value="asia">Asia</option><option value="sea">SEA</option></select></label>
        </div>
